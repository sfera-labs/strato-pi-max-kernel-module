...
#define I2C_REG_WDT_DOWN_DELAY (I2C_REG_WDT_MAIN + 2)
#define I2C_REG_WDT_SD_SWITCH_CNT (I2C_REG_WDT_MAIN + 3)
#define I2C_REG_WDT_PCIE_SWITCH_CNT (I2C_REG_WDT_MAIN + 4)
...
#define I2C_EXPB_IDX_TO_REG_START(EXPB_IDX) \
  (I2C_REG_EXPB_START + (EXPB_IDX * I2C_REG_EXPB_SIZE))
#define I2C_REG_TO_EXPB_IDX(REG) \
  ((REG - I2C_REG_EXPB_START) / I2C_REG_EXPB_SIZE)

#define I2C_REG_UPS_MAIN I2C_REG_EXPB_START
#define I2C_REG_UPS_CAPACITY (I2C_REG_UPS_MAIN + 1)
#define I2C_REG_UPS_MAX_CHARGE_I (I2C_REG_UPS_MAIN + 2)
#define I2C_REG_UPS_POWER_DOWN_DELAY (I2C_REG_UPS_MAIN + 3)
#define I2C_REG_UPS_STATE (I2C_REG_UPS_MAIN + 5)
#define I2C_REG_UPS_VBAT_V (I2C_REG_UPS_MAIN + 6)
#define I2C_REG_UPS_VBAT_I (I2C_REG_UPS_MAIN + 7)
